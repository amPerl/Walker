...
namespace Walker.Shared.Map
{
    static class BinaryExtensions
    {
        ...
        {
            ushort bufferLength = reader.ReadUInt16();
            byte[] strBuffer = reader.ReadBytes(bufferLength);
    ...
    public class Tileset
    {
        ...
        {
            string name = reader.ReadFixedString();
            string imagePath = reader.ReadFixedString();

            Tileset tileset = new Tileset(name, imagePath)
            {
        ...
        public void Write(BinaryWriter writer)
        {
            ...
            writer.Write(TileCount); // TODO: write actual tiles?
    ...
    public class TilePropertyEntry
    {
        ...
        {
            TilePropertyEntry tile = new TilePropertyEntry
            {
                Id = reader.ReadInt32()
            };
            ...
            for (int i = 0; i < propertyCount; i++)
            {
                string key = reader.ReadFixedString();
                string value = reader.ReadFixedString();
